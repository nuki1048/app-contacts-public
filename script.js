...
var _clockAttribute = /*#__PURE__*/new WeakMap();
var _date = /*#__PURE__*/new WeakMap();
/* eslint-disable no-param-reassign */
/* eslint-disable class-methods-use-this */
var Clock = /*#__PURE__*/function () {
  function Clock(clockAttribute) {
    _classCallCheck(this, Clock);
    _classPrivateFieldInitSpec(this, _clockAttribute, {
      writable: true,
      value: void 0
    });
    ...
    try {
      _classPrivateFieldSet(this, _clockAttribute, document.querySelector(clockAttribute));
    } catch (error) {
      /* empty */
    }
  ...
  _createClass(Clock, [{
    ...
    key: "updateClock",
    value: function updateClock(selector) {
      this.dateStart = new Date();
      var hours = this.getZero(this.dateStart.getHours());
      var minutes = this.getZero(this.dateStart.getMinutes());
      selector.textContent = "";
      selector.textContent = "".concat(hours, ":").concat(minutes);
    }
  }, {
    key: "render",
    value: function render() {
      var _this = this;
      this.updateClock(_classPrivateFieldGet(this, _clockAttribute));
      setInterval(function () {
        _this.updateClock(_classPrivateFieldGet(_this, _clockAttribute));
      }, 1000);
    }
  }]);
  return Clock;
...
function _classExtractFieldDescriptor(receiver, privateMap, action) { if (!privateMap.has(receiver)) { throw new TypeError("attempted to " + action + " private field on non-instance"); } return privateMap.get(receiver); }
function _classApplyDescriptorSet(receiver, descriptor, value) { if (descriptor.set) { descriptor.set.call(receiver, value); } else { if (!descriptor.writable) { throw new TypeError("attempted to set read only private field"); } descriptor.value = value; } }
var _dateSelector = /*#__PURE__*/new WeakMap();
var _date = /*#__PURE__*/new WeakMap();
var _dayToString = /*#__PURE__*/new WeakSet();
var _monthToString = /*#__PURE__*/new WeakSet();
var DateHome = /*#__PURE__*/function () {
  function DateHome(DateSelector) {
    ...
    _classPrivateFieldInitSpec(this, _dateSelector, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec(this, _date, {
    ...
    _classPrivateFieldSet(this, _dateSelector, document.querySelector(DateSelector));
    _classPrivateFieldSet(this, _date, new Date());
  }
  _createClass(DateHome, [{
    key: "render",
    value: function render() {
      var day = _classPrivateMethodGet(this, _dayToString, _dayToString2).call(this, _classPrivateFieldGet(this, _date).getDay());
      var month = _classPrivateMethodGet(this, _monthToString, _monthToString2).call(this, _classPrivateFieldGet(this, _date).getMonth() + 1);
      var date = _classPrivateFieldGet(this, _date).getDate();
      try {
        _classPrivateFieldGet(this, _dateSelector).textContent = "".concat(day, ", ").concat(month, " ").concat(date);
      } catch (error) {
        /* empty */
      }
    }
...
function _monthToString2(monthNum) {
  switch (monthNum) {
    case 1:
      return "January";
    case 2:
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DateHome);

/***/ }),

/***/ "./src/js/modules/homeIndicator/homeIndicator.js":
/*!*******************************************************!*\
  !*** ./src/js/modules/homeIndicator/homeIndicator.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var HomeIndicator = /*#__PURE__*/function () {
  function HomeIndicator(options) {
    _classCallCheck(this, HomeIndicator);
  ...
  _createClass(HomeIndicator, [{
    key: "render",
    value: function render() {
      var _this = this;
      try {
        this.HomeIndicator.addEventListener("click", function () {
          _this.lockScreen.classList.remove("animate__fadeIn");
          _this.lockScreen.classList.add("animate__fadeOutUp");
          setTimeout(function () {
            _this.lockScreen.style.display = "none";
            _this.homeScreen.style.display = "block";
            _this.homeScreen.classList.add("animate__fadeIn");
          });
        });
      } catch (error) {
        /* empty */
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (HomeIndicator);

/***/ }),

/***/ "./src/js/modules/human/Human.js":
/*!***************************************!*\
  !*** ./src/js/modules/human/Human.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _services_http__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../services/http */ "./src/js/services/http.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var Human = /*#__PURE__*/function () {
  function Human(name, gender, email, telephone, id) {
    ...
    _classPrivateFieldInitSpec(this, _gender, {
      writable: true,
      value: void 0
    });
    ...
    _classPrivateFieldInitSpec(this, _telephone, {
      writable: true,
      value: void 0
    });
    this.nameForModal = name;
    _classPrivateFieldSet(this, _name, name);
    _classPrivateFieldSet(this, _gender, gender);
    ...
    if (_classPrivateFieldGet(this, _name) === "" || _classPrivateFieldGet(this, _gender) === "" || _classPrivateFieldGet(this, _email) === "" || _classPrivateFieldGet(this, _telephone) === "") {
  ...
  _createClass(Human, [{
    ...
    value: function openPopupInfo(name, telephone, id) {
      ...
      popup.querySelector(".button__delete").addEventListener("click", function () {
        _this["delete"](id);
      });
    }
  }, {
    ...
    value: function getGender() {
      return _classPrivateFieldGet(this, _gender);
    }
  }, {
    key: "changeTelephone",
    value: function changeTelephone(tel) {
      this.renderToServer();
      _classPrivateFieldSet(this, _telephone, tel);
    }
  }, {
    key: "getTelephone",
    ...
    key: "renderToServer",
    value: function renderToServer() {
      var body = JSON.stringify({
        id: _classPrivateFieldGet(this, _id),
        name: _classPrivateFieldGet(this, _name),
        tel: _classPrivateFieldGet(this, _telephone),
        email: _classPrivateFieldGet(this, _email)
      });
      (0,_services_http__WEBPACK_IMPORTED_MODULE_16__["default"])("https://645636932e41ccf16916a499.mockapi.io/contacts/", "POST", body);
    }
  }, {
    key: "changeInfoOnServer",
    value: function changeInfoOnServer(obj) {
      (0,_services_http__WEBPACK_IMPORTED_MODULE_16__["default"])("https://645636932e41ccf16916a499.mockapi.io/contacts/".concat(_classPrivateFieldGet(this, _id)), "PATCH", JSON.stringify(obj));
    }
  }, {
    key: "delete",
    value: function _delete() {
      var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _classPrivateFieldGet(this, _id);
      var popup = document.querySelector(".popup__form_activeContact");
      (0,_services_http__WEBPACK_IMPORTED_MODULE_16__["default"])("https://645636932e41ccf16916a499.mockapi.io/contacts/".concat(id), "DELETE").then(function () {
        popup.classList.remove("animate__fadeInDown");
        popup.classList.add("animate__fadeOutUp");
        setTimeout(function () {
          popup.style.display = "none";
      ...
      }).then(document.querySelector("[data-id=\"".concat(_classPrivateFieldGet(this, _id), "\"]")).remove());
    }
  }, {
    key: "renderToDOM",
    value: function renderToDOM() {
      var _this2 = this;
      var parentSelector = document.querySelector(".contacts__list_grid");
      var li = document.createElement("li");
      li.classList.add("contact");
      li.setAttribute("data-id", _classPrivateFieldGet(this, _id));
      li.innerHTML = "<img\n      class=\"contact__avatar\"\n      src=\"./icons/contacts/newContactIcon.svg\"\n      alt=\"\" />\n      <h3 class=\"contact__title\">".concat(_classPrivateFieldGet(this, _name), "</h3>\n      <div class=\"contact__actions\">\n         <div class=\"actions__callBtn\">\n            <img\n               src=\"./icons/contacts/callIcon.svg\"\n               alt=\"call btn\"\n            />\n         </div>\n         <div class=\"actions__messageBtn\">\n            <img\n               src=\"./icons/contacts/messageIcon.svg\"\n               alt=\"message btn\"\n            />\n         </div>\n      </div>");
      parentSelector.append(li);
      li.addEventListener("click", function () {
        _this2.openPopupInfo(_classPrivateFieldGet(_this2, _name), _classPrivateFieldGet(_this2, _telephone), _classPrivateFieldGet(_this2, _id));
      });
    }
  }]);
  return Human;
...
/***/ "./src/js/modules/telephone/TelephoneClass.js":
/*!****************************************************!*\
  !*** ./src/js/modules/telephone/TelephoneClass.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _services_http__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ../../services/http */ "./src/js/services/http.js");
/* harmony import */ var _human_Human__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ../human/Human */ "./src/js/modules/human/Human.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var _renderOnServer = /*#__PURE__*/new WeakSet();
var _addNewContact = /*#__PURE__*/new WeakSet();
var _validate = /*#__PURE__*/new WeakSet();
var _fetchData = /*#__PURE__*/new WeakSet();
var _renderListToDom = /*#__PURE__*/new WeakSet();
var _setFilter = /*#__PURE__*/new WeakSet();
var Telephone = /*#__PURE__*/function () {
  function Telephone(model, category) {
    _classCallCheck(this, Telephone);
    _classPrivateMethodInitSpec(this, _setFilter);
    _classPrivateMethodInitSpec(this, _renderListToDom);
    _classPrivateMethodInitSpec(this, _fetchData);
    _classPrivateMethodInitSpec(this, _validate);
    _classPrivateMethodInitSpec(this, _addNewContact);
    _classPrivateMethodInitSpec(this, _renderOnServer);
    ...
    _classPrivateFieldInitSpec(this, _company, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec(this, _telephone, {
    ...
    _classPrivateFieldSet(this, _firstName, "");
    _classPrivateFieldSet(this, _lastName, "");
    _classPrivateFieldSet(this, _company, "");
    _classPrivateFieldSet(this, _telephone, "");
    _classPrivateFieldSet(this, _email, "");
    _classPrivateFieldSet(this, _filter, "");
    _classPrivateFieldSet(this, _data, []);
    if (_classPrivateFieldGet(this, _model) === "" || _classPrivateFieldGet(this, _category) === "") {
      throw new Error("Can't create a class Telephone");
    }
  }
  _createClass(Telephone, [{
    key: "render",
    value: // eslint-disable-next-line getter-return, class-methods-use-this
    function () {
      var _render = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _classPrivateMethodGet(this, _fetchData, _fetchData2).call(this);
            case 2:
              _classPrivateMethodGet(this, _addNewContact, _addNewContact2).call(this);
              _classPrivateMethodGet(this, _renderListToDom, _renderListToDom2).call(this);
              _classPrivateMethodGet(this, _setFilter, _setFilter2).call(this);
            case 5:
            case "end":
...
function _renderOnServer2() {
  (0,_services_http__WEBPACK_IMPORTED_MODULE_35__["default"])("https://645636932e41ccf16916a499.mockapi.io/category", "POST", JSON.stringify(_classPrivateFieldGet(this, _category)));
}
function _addNewContact2() {
  var _this = this;
  var btn = document.querySelector(".search__block-addBtn");
  btn.addEventListener("click", function (e) {
    if (e.target.classList.contains("search__block-addBtn")) {
      var popup = document.createElement("div");
      popup.classList.add("popup", "popup__form_newContact", "animate__animated", "animate__fadeInDown");
      ...
      popup.style.display = "block";
      popup.addEventListener("click", function (event) {
        if (event.target.classList.contains("form__newContact_cancel") || event.target.classList.contains("mockup__homeIndicator")) {
        ...
        } else if (event.target.classList.contains("form__newContact_done")) {
          var id = Math.floor(Math.random() * (100 - 1) + 1);
          var body = JSON.stringify({
            name: "".concat(_classPrivateFieldGet(_this, _firstName), " ").concat(_classPrivateFieldGet(_this, _lastName)),
            tel: _classPrivateFieldGet(_this, _telephone),
            company: _classPrivateFieldGet(_this, _company),
            email: _classPrivateFieldGet(_this, _email),
            id: id
          });
          (0,_services_http__WEBPACK_IMPORTED_MODULE_35__["default"])("https://645636932e41ccf16916a499.mockapi.io/contacts", "POST", body);
          popup.classList.remove("animate__fadeInDown");
          popup.classList.add("animate__fadeOutUp");
          setTimeout(function () {
            popup.remove();
          }, 500);
          new _human_Human__WEBPACK_IMPORTED_MODULE_36__["default"]("".concat(_classPrivateFieldGet(_this, _firstName), " ").concat(_classPrivateFieldGet(_this, _lastName)), "Male", _classPrivateFieldGet(_this, _email), _classPrivateFieldGet(_this, _telephone), id).renderToDOM();
          _this.render();
        }
      });
      popup.addEventListener("input", function (eventN) {
        _classPrivateMethodGet(_this, _validate, _validate2).call(_this, eventN);
      });
    }
  });
}
function _validate2(event) {
  switch (event.target.classList[1]) {
    case "input__firstName":
      _classPrivateFieldSet(this, _firstName, event.target.value);
      break;
    case "input__lastName":
      _classPrivateFieldSet(this, _lastName, event.target.value);
      break;
    case "input__company":
      _classPrivateFieldSet(this, _company, event.target.value);
      break;
    case "input__telephone":
      _classPrivateFieldSet(this, _telephone, event.target.value);
      break;
    case "input__email":
      _classPrivateFieldSet(this, _email, event.target.value);
      break;
    default:
...
function _fetchData3() {
  _fetchData3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return (0,_services_http__WEBPACK_IMPORTED_MODULE_35__["default"])("https://645636932e41ccf16916a499.mockapi.io/contacts");
        case 2:
          res = _context2.sent;
          _classPrivateFieldSet(this, _data, [].concat(_toConsumableArray(_classPrivateFieldGet(this, _data)), _toConsumableArray(res)));
        case 4:
        case "end":
...
function _renderListToDom2() {
  var _this2 = this;
  var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _classPrivateFieldGet(this, _data);
  document.querySelector(".contacts__list_grid").innerHTML = "";
  if (_classPrivateFieldGet(this, _filter) === "") {
    return data.map(function (item) {
      var gender = "male";
      return new _human_Human__WEBPACK_IMPORTED_MODULE_36__["default"](item.name, gender, item.email, item.tel, item.id).renderToDOM();
    });
  }
  return data.filter(function (item) {
    return item.name.toLowerCase().includes(_classPrivateFieldGet(_this2, _filter).toLowerCase()) || item.email.toLowerCase().includes(_classPrivateFieldGet(_this2, _filter).toLowerCase()) || item.tel.toLowerCase().includes(_classPrivateFieldGet(_this2, _filter).toLowerCase());
  }).map(function (item) {
    var gender = "male";
    return new _human_Human__WEBPACK_IMPORTED_MODULE_36__["default"](item.name, gender, item.email, item.tel, item.id).renderToDOM();
  });
...
function _setFilter2() {
  var _this3 = this;
  var input = document.querySelector(".search__block-mainInput");
  input.addEventListener("input", function (e) {
    _classPrivateFieldSet(_this3, _filter, e.target.value);
    console.log(_classPrivateFieldGet(_this3, _filter));
    _classPrivateMethodGet(_this3, _renderListToDom, _renderListToDom2).call(_this3);
  });
}
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var httpSevice = /*#__PURE__*/function () {
  ...
  return function httpSevice(_x) {
    return _ref.apply(this, arguments);
  };
}();
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (httpSevice);
...
/* harmony import */ var core_js_modules_web_timers_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.timers.js */ "./node_modules/core-js/modules/web.timers.js");
/* harmony import */ var core_js_modules_web_timers_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_timers_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _modules_clock_clock__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/clock/clock */ "./src/js/modules/clock/clock.js");
/* harmony import */ var _modules_date_Date__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/date/Date */ "./src/js/modules/date/Date.js");
/* harmony import */ var _modules_homeIndicator_homeIndicator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/homeIndicator/homeIndicator */ "./src/js/modules/homeIndicator/homeIndicator.js");
/* harmony import */ var _modules_telephone_TelephoneClass__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/telephone/TelephoneClass */ "./src/js/modules/telephone/TelephoneClass.js");
...
document.addEventListener("DOMContentLoaded", function () {
  var statusBarTimeClock = new _modules_clock_clock__WEBPACK_IMPORTED_MODULE_1__["default"]("[data-timeClock]");
  setInterval(function () {
    try {
      var lockScreenTimeClock = new _modules_clock_clock__WEBPACK_IMPORTED_MODULE_1__["default"]("[data-timeLock]");
      if (window.getComputedStyle(document.querySelector("[data-timeLock]").parentNode).display !== "none") {
  ...
  var date = new _modules_date_Date__WEBPACK_IMPORTED_MODULE_2__["default"](".lock__screen_date");
  date.render();
  var home = new _modules_homeIndicator_homeIndicator__WEBPACK_IMPORTED_MODULE_3__["default"]({
  ...
  var telephone = new _modules_telephone_TelephoneClass__WEBPACK_IMPORTED_MODULE_4__["default"]("IPHONE_14", "mobile");
  telephone.render();
});
})();
